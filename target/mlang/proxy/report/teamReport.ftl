...
<#if permAdminFn.hadPermission("admin:teamReport:export")><div class="hidden">
    <form id="team_report_rd_export_fmId" action="${proxyBase}/teamReport/export.do" target="_blank" method="post">
...
<script type="text/javascript">
    requirejs(['jquery', 'bootstrap', 'Fui'], function () {
        ...
        Fui.addBootstrapTable({
            url: '${proxyBase}/teamReport/list.do',
        ...
        function usernameFormatter(value, row, index) {
            return '<a class="open-tab" href="${proxyBase}/user/detail.do?id='+row.userId+'" title="<@spring.message "admin.check.member.info"/>"  id="fui_tab_detailNew"><span class="text-danger">'+value+'</span></a>';
        }
