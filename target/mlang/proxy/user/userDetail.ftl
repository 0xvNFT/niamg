  		...
  		<table class="table table-striped table-bordered">
            ...
            <tr>
                <td><@spring.message "admin.finance.all.money"/>:<span class="text-danger">${money}<#if user.moneyStatus==1><span class="text-danger"><@spring.message "admin.forze"/></span></#if></span>
                    <#if permAdminFn.hadPermission("admin:moneyHistory")>&nbsp;&nbsp;<a class="open-tab" title="<@spring.message "admin.vip.account.manage"/>" href="${proxyBase}/finance/moneyHistory/index.do?username=${user.username}"><@spring.message "admin.account.change"/></a></#if>
                    <#if permAdminFn.hadPermission("admin:globalReport")>&nbsp;&nbsp;<a class="open-tab" href="${proxyBase}/globalReport/index.do?username=${user.username}"title="<@spring.message "admin.all.report.manage"/>"><@spring.message "admin.report"/></a></#if>
                    <#if permAdminFn.hadPermission("admin:moneyReport")>&nbsp;&nbsp;<a class="open-tab" href="${proxyBase}/moneyReport/index.do?username=${user.username}"title="<@spring.message "admin.finance.report.manage"/>"><@spring.message "admin.finance.cash"/></a></#if>
                    <#if permAdminFn.hadPermission("admin:userData")>&nbsp;&nbsp;<a class="open-tab"href="${proxyBase}/userData/index.do?username=${user.username}"title="<@spring.message "admin.member.info"/>"><@spring.message "admin.memo"/></a></#if>
                </td>
...
<#--        </#if>-->
        <#list banks as b>
        	<tr>
        		<td><@spring.message "admin.real.name"/>:&nbsp;&nbsp;${b.realName}</a>
                <td><@spring.message "admin.bank.num"/>:&nbsp;&nbsp;${b.cardNo}<#if permAdminFn.hadPermission("admin:userBank")><a class="open-tab" title="<@spring.message "admin.vip.bank.card.manage"/>" href="${proxyBase}/userBank/index.do?username=${user.username}"><@spring.message "admin.view.more.bank.num"/></a></#if></td>
            ...
            <tr>
                ...
                <td><@spring.message "admin.bit.weight"/>:&nbsp;&nbsp;${bet.betNum }<#if permAdminFn.hadPermission("admin:betNumOpe")>&nbsp;&nbsp;<a class="open-tab" title="<@spring.message "admin.vip.bit.weight"/>" href="${proxyBase}/finance/betNumOpe/index.do?username=${user.username}"><@spring.message "admin.add.discount.weight"/></a></#if>
                    <#if permAdminFn.hadPermission("admin:betNumHistory")>&nbsp;&nbsp;<a class="open-tab" title="<@spring.message "admin.account.code.change.rec"/>" href="${proxyBase}/finance/betNumHistory/index.do?username=${user.username}"><@spring.message "admin.account.code.change.rec"/></a></#if>
                </td>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tr>
            	<#list platforms as p>
            	<td>${p.name}<@spring.message "admin.money.values"/>:<span class="text-danger platform${p.platform}">0</span>&nbsp;</td>
        ...
        <table class="table table-striped table-bordered">
        	...
        	<#if thirdGame.live==2>
                ...
                <td>${todayMoney.liveBetAmount}/${todayMoney.liveBetNum}&nbsp;&nbsp;<a class="open-tab" href="${proxyBase}/liveRecord/index.do?username=${user.username}"><@spring.message "admin.view.record"/></a></td>
            </#if>
        	<#if thirdGame.egame==2>
                <th class="text-right"><@spring.message "admin.egame.record"/>：</th>
                <td>${todayMoney.egameBetAmount}/${todayMoney.egameBetNum}&nbsp;&nbsp;<a class="open-tab" href="${proxyBase}/egameRecord/index.do?username=${user.username}"><@spring.message "admin.view.record"/></a></td>
            </#if>
            <#if thirdGame.chess==2>
                <th class="text-right"><@spring.message "admin.chess.record"/>：</th>
                <td>${todayMoney.chessBetAmount}/${todayMoney.chessBetNum}&nbsp;&nbsp;<a class="open-tab" href="${proxyBase}/chessRecord/index.do?username=${user.username}"><@spring.message "admin.view.record"/></a></td>
            </#if>
            <#if thirdGame.sport==2>
                <th class="text-right"><@spring.message "admin.sports.record"/>：</th>
                <td>${todayMoney.sportBetAmount}/${todayMoney.sportBetNum}&nbsp;&nbsp;<a class="open-tab" href="${proxyBase}/sportRecord/index.do?username=${user.username}"><@spring.message "admin.view.record"/></a></td>
            </#if>
            </tr>
            <tr>
            <#if thirdGame.esport==2>
                <th class="text-right"><@spring.message "admin.power.record"/>：</th>
                <td>${todayMoney.esportBetAmount}/${todayMoney.esportBetNum}&nbsp;&nbsp;<a class="open-tab" href="${proxyBase}/esportRecord/index.do?username=${user.username}"><@spring.message "admin.view.record"/></a></td>
            </#if>
            <#if thirdGame.fishing==2>
                <th class="text-right"><@spring.message "admin.fish.record"/>：</th>
                <td>${todayMoney.fishingBetAmount}/${todayMoney.fishingBetNum}&nbsp;&nbsp;<a class="open-tab" href="${proxyBase}/fishingRecord/index.do?username=${user.username}"><@spring.message "admin.view.record"/></a></td>
            </#if>
            <#if thirdGame.lottery==2>
                <th class="text-right"><@spring.message "admin.lottery.record"/>：</th>
                <td>${todayMoney.lotBetAmount}/${todayMoney.lotBetNum}&nbsp;&nbsp;<a class="open-tab" href="${proxyBase}/lotRecord/index.do?username=${user.username}"><@spring.message "admin.view.record"/></a></td>
            </#if>
            </tr>
            </tbody>
        </table>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td width="30%">${draw.times}&nbsp;&nbsp;<a class="open-tab" title="<@spring.message "admin.website.record"/>" href="${proxyBase}/finance/withdraw/index.do?username=${user.username}"><@spring.message "admin.view.draw.record"/></a></td>
            ...
            <tr>
                ...
                <td>${deposit.times}&nbsp;&nbsp;<a class="open-tab" title="<@spring.message "admin.website.pay.record"/>" href="${proxyBase}/finance/deposit/index.do?username=${user.username}"><@spring.message "admin.view.save.rec"/></a></td>
...
$(function () {
	...
	function getBalance(p) {
	    $.ajax({
	        type: 'GET',
	        url: '${proxyBase}/thirdMoney/getBalance.do',
