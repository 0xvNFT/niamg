<form action="${managerBase}/adminUserGroup/addAuth.do" class="form-submit" id="setAuthFormId">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close fui-close" aria-hidden="true">&times;</button>
				<h4 class="modal-title"><@spring.message "manager.setting.station.admin.group"/>【${group.name}】<@spring.message "manager.perm.name"/></h4>
			</div><input type="hidden" value="${group.id}" name="groupId"><input type="hidden" value="${group.stationId}" name="stationId">
