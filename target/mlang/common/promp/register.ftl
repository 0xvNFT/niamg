<!DOCTYPE html>
<!-- saved from url=(0036)https://aff.hggbet.com/register/form -->
<html lang="en">

<head>
  <meta charset="utf-8">
  <!-- <link rel="icon" style="border-radius:50%" href="favicon.ico"> -->
  <meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=0,viewport-fit=cover">
  <meta name="theme-color" content="#000000">
  <link rel="apple-touch-icon" href="logo192.png">
  <!-- <link rel="manifest" href="./manifest.json"> -->
  <title>Promotion Register</title>
  ...
  <meta property="og:image" content="https://aff.hggbet.com/screenshot-hggbet.com.webp">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Affiliate | Hggbet.com">
  <#assign res="${base}/common/promp">
  <link href="${res}/css/ceh.css?v=611" rel="stylesheet">
  ...
  <script type="text/JavaScript" src="${res}/js/manifest.js?v=1.1.4"></script>
        ...
        <div class="section-home-inner">
          <div class="member-section">
            <div class="btn-holder">
              <a id="btn-loginHolder" class="loginG" href="${base}/promp/login.do">登录</a>
              <a id="btn-registerHolder" class="active registerR" href="${base}/promp/register.do">注册</a>
            </div>
            <form id="loginHolder" novalidate="" class="form-holder" style="display: block;">
              <div style="display: flex; justify-content: center; margin-bottom: 1rem;" id="registerSelect">
                <div
                  style="margin: 0px 0.5rem; padding: 1rem; width: 40px; height: 40px; border: 1px solid rgb(204, 204, 204); border-radius: 50%; background-color: rgb(133, 73, 21); color: rgb(255, 255, 255);">
                  1</div>
                <div
                  style="margin: 0px 0.5rem; padding: 1rem; width: 40px; height: 40px; border: 1px solid rgb(204, 204, 204); border-radius: 50%; background-color: rgb(240, 240, 240); color: rgb(0, 0, 0);">
                  2</div>
              </div>
              <div id='select1'>
                <div class="form-group">
                  <div class="input-group">
                    <input id="register_username" name="userName" placeholder="用户名" type="text"
                      class="form-control is-invalid form-control userName userName" value="" aria-invalid="请输入您的用户名">
                  </div>
                  <!-- <div class="jErr">请输入您的用户名</div> -->
                </div>
                <div class="form-group">
                  <div class="input-group"><input id="register_password" name="pwd" placeholder="密码"
                      type="password" class="form-control form-control passWord" value="">
                    <!-- <span
                      class="input-group-addon btn-icon"><i class="fa fa-eye-slash vPassView"></i></span> -->
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group">
                    <input id="register_confirmPassword" name="rpwd" placeholder="确认密码" type="password"
                      class="form-control pe-5 form-control confirmPassword" value="">
                    <!-- <span class="input-group-addon btn-icon"><i
                        class="fa fa-eye-slash vPassView"></i></span> -->
                  </div>
                </div>
                <button type="button" class="btn btn-secondary goNext" style="background-color: rgb(133, 73, 21);"
                  onclick="next()">下一步</button>
              </div>
              <div id='select2' style="display: none;">+
               <#list regConfs as r>
                    <#if r.eleName=="username" || r.eleName=="pwd" || r.eleName=="rpwd" || r.eleName=="captcha">
                    <#else>
                <#--  <div class="form-group">
                  <div class="input-group"><input id="register_realname" name="realName" placeholder="真实姓名" type="text"
                      class="form-control is-invalid form-control realName" value="" aria-invalid="请输入您的真实姓名"></div>
                 
                </div> -->
                <div class="form-group">
                  <div class="input-group"><input name="${r.eleName}" type="text" placeholder="<@spring.message '${r.code}'/>" type="text"
                ...
                <div class="form-group">
                  <div class="input-group">
                    <input id="register_validcode" autocomplete="off" name="password" placeholder="*请输入验证码" type="text"
                    ...
                    <span class="input-group-addon btn-icon">
                      <div class="verification_but" style="margin-top:-8px"><img id="vcode_img"
                          src="${base}/registerVerifycode.do" id="validcode"></div>
                    </span>
                  </div>
                </div>
                <button type="button" class="btn btn-secondary goBack" style="background-color: rgb(133, 73, 21);"
                  onclick="last()">上一步</button>
                <button type="button" class="btn btn-secondary registerR" style="background-color: rgb(133, 73, 21);"
        ...
        <div class="seperateBox footerCont footerSecondCont">
          <div class="footerBox">
            ...
            <div class="mgt15">
              <div class="box">
                <ul>
                  <li><a href="https://aff.hggbet.com/faq" class="faqs">常见问题</a></li>
                  <li><a href="https://aff.hggbet.com/contact-us" class="connectUs">联系我们</a></li>
                </ul>
              </div>
            </div>
          </div>
...
<script>
  ...
  function next () {
    $('#registerSelect').children().eq(0).css({ color: '#000', background: 'rgb(255, 255, 255)' })
    $('#registerSelect').children().eq(1).css({ background: 'rgb(133, 73, 21)', color: 'rgb(255, 255, 255)' })
    $('#select1').toggle()
    $('#select2').toggle()
  ...
  function last () {
    $('#registerSelect').children().eq(1).css({ color: '#000', background: 'rgb(255, 255, 255)' })
    $('#registerSelect').children().eq(0).css({ background: 'rgb(133, 73, 21)', color: 'rgb(255, 255, 255)' })
    $('#select2').toggle()
    $('#select1').toggle()
  ...
  $('#vcode_img').click(function () {
    var _this = $(this);
    $('#vcode_img').attr("src", "${base}/registerVerifycode.do?timestamp=" + (new Date().getTime()));
  });
  ...
  function register () {
    ...
    var rpwd = $('#register_confirmPassword').val();
    var email = $('#register_email').val();
    var verifyCode = $('#register_validcode').val();
