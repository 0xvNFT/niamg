  ...
  <div class="index-gameList" id="backTop">
    ...
    >
      ...
      >
        ...
        <img
          :src="
            require('../../assets/images/index/index_' + item.code + '.png')
          "
          alt=""
          v-else
        />
          ...
          <div class="blurImg" v-for="(game, k) in gameList" :key="k">
            ...
            <div class="homeTitle" v-if="game.tab">
              ...
              <div class="left">
                ...
                <img
                  :src="
                    require('../../assets/images/index/index_' +
                      game.tab.code +
                      '.png')
                  "
                  alt=""
...
import gameSkeleton from "@/components/index/gameSkeleton.vue";
