...
<template>
  <el-dialog :visible.sync="showGame" :show-close="false" data-v-container>
    ...
    <div class="main-container">
      <div class="game-box">
        <img class="img-spin" src="@/assets/images/da_zhuan_pan/circle_blue.png" alt="蓝色外层旋转盘">
        <img class="img-spin" src="@/assets/images/da_zhuan_pan/circle_white.png" alt="白色外层旋转盘">
        <div class="all-rewards">
          <div class="circle-box">
            <img src="@/assets/images/da_zhuan_pan/circle_zhuanpan.png" alt="转盘板面" :style="spinningStyle">
            <img src="@/assets/images/da_zhuan_pan/icon_arrow.png" alt="箭头">
            <img src="@/assets/images/da_zhuan_pan/circle_centerbutton.png" alt="转盘按钮" @click="toSpin()">
          </div>
        </div>
      </div>
      <div class="right--content-box">
        <div class="right--content-top">
          <div class="top--controls">
            ...
            <nav class="controls-box">
              <img src="@/assets/images/da_zhuan_pan/icon_question.png" @click="toShowDrawer(true, true)" alt="查看游戏规则">
              <img @click="toControlAudio(!music)" :src="`../../src/assets/images/da_zhuan_pan/icon_music_${music ? 'on' : 'off'}.png`" alt="音频">
              <img @click="showGame = false" src="@/assets/images/da_zhuan_pan/icon_close.png" alt="关闭">
            </nav>
            <!-- 游戏音频 -->
        ...
        <img src="@/assets/images/da_zhuan_pan/person.png" class="right--content-peson" />
    ...
    <div class="right--drawer-box">
      <aside class="right-drawer" :class="{show: showDrawer}">
        <div class="drawer--title">
          ...
          <img src="@/assets/images/da_zhuan_pan/icon_close.png" @click="toShowDrawer(false)" alt="">
        </div>
...
div[data-v-container] {
  ...
  /deep/.el-dialog {
    ...
    box-shadow: none;
    font-weight: 700;
    background: no-repeat center/100% url('../../assets/images/da_zhuan_pan/main_background.png');
    .main-container {
      position: relative;
      .game-box {
        top: -120px;
      ...
      .right--content-box {
        ...
        .right--content-top {
          ...
          height: 117px;
          position: relative;
          background: no-repeat center/100% url('../../assets/images/da_zhuan_pan/topright_background.png');
          .top--controls {
            position: absolute;
            display: flex;
            flex-wrap: wrap;
        ...
        .right--content-bottom {
          ...
          .bottom--playslots {
            ...
            width: 283px;
            height: 74px;
            background: no-repeat center/100% url('../../assets/images/da_zhuan_pan/number_background.png');
            em {
              font-size: 26px;
              top: 50%;
              left: 50%;
            ...
            div {
              ...
              right: -30px;
              top: -30px;
              background: no-repeat center/100% url('../../assets/images/da_zhuan_pan/circle_numberbackground.png');
              em {
                margin-left: -2px;
              }
            }
