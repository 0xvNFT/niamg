    ...
    <div class="user-info">
      <div class="userBox">
        <div class="item clearfix">
          ...
          <div class="info">
            <img
              src="https://pbs.twimg.com/profile_images/848050357234216960/KPJTTZ10_400x400.jpg"
              class="levelIcon"
...
export default {
  ...
  methods: {
    refreshInfo() {
      this.$axiosPack
        .post("/userInfo/getInfo.do?refresh_=" + new Date().getTime(), {
