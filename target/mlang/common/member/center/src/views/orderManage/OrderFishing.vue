<template>
  <div class="order-page">
    ...
    <el-table :data="tableData" style="width: 99%">
      ...
      <el-table-column :label="$t('nameAndPlayName')">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    searchMethod (startTime, endTime, isSearch) {
      ...
      this.$axiosPack.post("/userCenter/third/fishRecord.do", { params: params, load: [true, 200, null] }).then(res => {
        if (res) {
          this.data = res.data
