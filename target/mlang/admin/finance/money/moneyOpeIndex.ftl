...
<form id="money_ope_form_id" method="post">
    <div class="form-inline">
        ...
        <button class="btn btn-primary open-dialog" type="button" url="${adminBase}/finance/moneyOpe/showBatchAdd.do"><@spring.message "admin.bat.add.money"/></button>
        <button class="btn btn-primary open-dialog" type="button" url="${adminBase}/finance/moneyOpe/showBatchSub.do"><@spring.message "admin.bat.decode.money"/></button>
    </div>
...
requirejs(['jquery'], function () {
    ...
    function search() {
        ...
        $.ajax({
            url: "${adminBase}/finance/moneyOpe/getMoney.do?username=" + acc,
            type: "GET",
    ...
    $form.submit(function () {
        ...
        saveExe = true;
        $.ajax({
            url: "${adminBase}/finance/moneyOpe/save.do",
            data: $form.serialize(),
            success: function (data) {
