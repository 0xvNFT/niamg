        ...
        <div class="form-group zhongjiang">
            <div class="form-group fui-data-wrap">
                <div class="form-inline">
                    ...
                    <button class="btn btn-primary open-dialog" url="${base}/admin/appTab/add.do"><@spring.message "admin.add"/></button>
                </div>
...
<script type="text/javascript">
    requirejs(['jquery','bootstrap','Fui'],function(){
        ...
        function statusFormatter(value, row, index) {
            return Fui.statusFormatter({val:value,url:"${base}/admin/appTab/updStatus.do?id="+row.id+"&status="});
        }


        function operateFormatter(value, row, index) {
            return  '<a class="open-dialog" href="${base}/admin/appTab/modify.do?id='+row.id+'"><@spring.message "admin.menu.modify"/></a>   '+
                '<a class="todo-ajax" href="${base}/admin/appTab/delete.do?id='+row.id+'" title="<@spring.message "admin.define.title"/>['+row.customTitle+']？"><@spring.message "admin.menu.del"/></a>';
        }
    });
</script>
