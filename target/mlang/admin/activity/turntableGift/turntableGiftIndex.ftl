...
<div class="table-tool">
    <div class="form-group">
        <button class="btn btn-primary open-dialog cached" url="${adminBase}/turntableGift/showAdd.do"><@spring.message "admin.menu.add"/></button>
    </div>
</div></#if>
    ...
    requirejs(['jquery', 'bootstrap', 'Fui'], function () {
        ...
        function operateFormatter(value, row, index) {
            ...
            <#if permAdminFn.hadPermission("admin:turntableGift:modify")>
                s=s+'<a class="open-dialog" href="${adminBase}/turntableGift/showModify.do?id='+row.id+'" title="<@spring.message "admin.menu.modify"/>"><i class="glyphicon glyphicon-pencil"></i></a>';
            </#if>
