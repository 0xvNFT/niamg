<form action="${adminBase}/depositStrategy/addSave.do" class="form-submit" id="mny_com_strategy_add_form_id">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close fui-close" aria-hidden="true">&times;</button>
                <h4 class="modal-title"><@spring.message "admin.add.deposit.act"/></h4>
            </div>
            <div class="modal-body"><input type="hidden" name="depositType" value="${type}"/>
              ...
              <table class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td width="30%"><select class="form-control" disabled>
                        <option value="7"<#if type==7>selected</#if>><@spring.message "admin.deposit.type.bank"/></option>
                        <option value="1"<#if type==1>selected</#if>><@spring.message "admin.deposit.type.manual"/></option>
                        <option value="5"<#if type==5>selected</#if>><@spring.message "admin.deposit.type.online"/></option>
                    </select></td>
                ...
                <tr>
                    ...
                    <td><select name="depositCount" class="form-control">
                        <option value="0" selected><@spring.message "admin.daily.pay"/></option>
                        <option value="1"><@spring.message "admin.first.pay"/></option>
                        <option value="444"><@spring.message "admin.daily.first.charge"/></option>
                        <option value="2"><@spring.message "admin.second.pay"/></option>
                        <option value="3"><@spring.message "admin.third.pay"/></option>
                        <option value="222"><@spring.message "admin.two.pay.before"/></option>
                        <option value="333"><@spring.message "admin.three.pay.before"/></option>
                    </select></td>
                </tr>
                <tr class="giftValue">
                ...
                <tr>
	                ...
	                <td><input type="text" name="minMoney" class="form-control money" placeholder="<@spring.message "admin.define.zero"/>" value="0"/></td>
	                <td class="text-right media-middle"><@spring.message "admin.charge.cash.less.equal"/>：</td>
	                <td><input type="text" name="maxMoney" class="form-control money" placeholder="默认为10000000000000<@spring.message ""/>" value="10000000000000"/></td>
                </tr>
                <tr class="dayUpperLimit">
                    <td class="text-right media-middle"><@spring.message "admin.single.day.give.top"/>：</td>
                    <td colspan="3"><input type="text" name="dayupperLimit" class="form-control money" placeholder="<@spring.message "admin.zero.no.top.max.give"/>" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="backRollbackValueFix2"><input type="text" name="backBonusLevelDiff" class="form-control money" placeholder="<@spring.message "admin.define.zero"/>" value="0"/></td>
                    <td class="hidden backRollbackValueFloat2">
                        <div class="input-group">
                            <input name="backBonusLevelDiffRate" type="text" class="form-control money" placeholder="<@spring.message "admin.no.input.mess"/>%">
                            <span class="input-group-addon">%</span>
                        </div>
                    </td>
                </tr>
                ...
                <tr class="deposit-config-check">
                    ...
                    <td colspan="3" class="deposit-config-check-tr">
                        <#list depositList as d>
                            <#if type==7><label class="checkbox-inline"><input type="checkbox" name="depositIds" value="${d.id }"checked>${d.bankName}(${d.creatorName})</label></#if>
                            <#if type==5><label class="checkbox-inline"><input type="checkbox" name="depositIds" value="${d.id }"checked>${d.payName}</label></#if>
                        </#list>
                     </td>
                </tr></#if>
                <tr>
