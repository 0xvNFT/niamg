<form action="${adminBase}/task/addSave.do" class="form-submit" id="mny_com_strategy_add_form_id">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close fui-close" aria-hidden="true">&times;</button>
                <h4 class="modal-title"><@spring.message "admin.add.task.act"/></h4>
            </div>
            <div class="modal-body"><input type="hidden" />
              ...
              <table class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td><select name="depositCount" class="form-control">
                        <#--<option value="1"><@spring.message "admin.addMosaic.multiple"/></option>-->
                        <option value="2"><@spring.message "admin.first.deposit"/></option>
                    </select></td>
                </tr>
                <tr class="giftValue">
                ...
                <#--<tr>-->
	                ...
	                <#--<td><input type="text" name="maxMoney" class="form-control money" placeholder="默认为1000万<@spring.message ""/>" value="10000000"/></td>-->
                <#--</tr>-->
                ...
                <#--<tr>-->
                    ...
                    <#--<td class="backRollbackValueFix"><input type="text" name="bonusBackValue" class="form-control money" placeholder="<@spring.message "admin.define.zero"/>" value="0"/></td>-->
