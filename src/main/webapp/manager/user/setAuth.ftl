<form action="${managerBase}/user/setAuth.do" class="form-submit" id="setAuthFormId">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close fui-close" aria-hidden="true">&times;</button>
				<h4 class="modal-title"><@spring.message "manager.admin.setting"/>${user.username}<@spring.message "manager.perm.name"/></h4>
