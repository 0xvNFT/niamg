  ...
  <div class="leftMenu" :class="leftMenuShow ? '' : 'hide'">
    ...
    <div class="leftMenu-top">
      ...
      <a href="#/userView" @click="goPage($event)">
        <img :src="$publicJs.imgUrlFun(appLang + '/grzl_img')" alt="" />
      </a>
      <div class="leftMenu-top-div">
        ...
        <a
          ...
          :key="forceUpdateKey"
        >
          <img :src="$publicJs.imgUrlFun(appLang + '/dzp_img')" alt="" />
        </a>
        <!-- 大转盘弹出框 -->
        ...
        >
          <img :src="$publicJs.imgUrlFun(appLang + '/hb_img')" alt="" />
        </a>
        <!-- 签到 -->
        <a
          href="/signIn.do"
        ...
        >
          <img :src="$publicJs.imgUrlFun(appLang + '/qd_img')" alt="" />
        </a>
      </div>
    </div>
    <!-- 中间图 优惠活动 -->
...
import TurntableGame from "./TurntableGame";
