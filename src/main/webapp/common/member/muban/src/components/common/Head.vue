  ...
  <div class="header">
    ...
    <div class="header-right" v-else>
      ...
      <div class="user_balance_bg">
        <div class="balance">
          <img src="@images/index/refresh_icon"
          class="icon-refresh" :class="{refreshing: spinning}" @click="refreshInfo">
        ...
        <div class="userHead-list">
          <div class="user_userDj">
            ...
            <div class="user_userinfo">
              <!-- 用户头像 -->
              <div class="user_head">
                <img :src="onOffBtn.avatarUrl ? onOffBtn.avatarUrl : require('@images/avatar')" alt="avatar"/>
              </div>
              <!-- 用户名 -->
            ...
            <div class="user_bonus">
              ...
              <div class="user_userDj_logo">
                <img :src="userInfo.userDegreeeIcon ? userInfo.userDegreeeIcon : require('@images/grade')" alt="grade"/>
              </div>
          ...
          <div class="menu_pane">
            <el-collapse v-model="activeMenu" accordion>
              ...
              <el-collapse-item name="2" v-banned:display>
                <template slot="title">
                  <img class="img-icon" src="@images/index/proxy_icon" alt="" />{{ $t("agentMenu") }}
                </template>
                <div class="cur-list">
                  <!-- 我的分享 -->
              ...
              <el-collapse-item name="4">
                <template slot="title">
                  <img class="img-icon" src="@images/index/report_icon" alt="" />{{ $t("recordMenu") }}
                </template>
                <div class="cur-list">
                  <!-- 存取记录 -->
          ...
          <div class="log_out_div" @click="logout">
            <i class="iconfont icon-tuichu"></i> {{ $t("logOut") }}
          </div>
  ...
  computed: {
    ...
    percentage() {
      ...
      if (degree >= 0 && degree <= 100)
        // 返回最多两个小数点的数字 
        return Number(degree.toLocaleString('en-IN', { maximumFractionDigits: 2 }));
      return 0;
    },
  },
  components: {},
