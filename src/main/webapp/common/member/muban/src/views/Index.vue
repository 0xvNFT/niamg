<template>
  <div class="index-page">
    <Carousel></Carousel>
    <GameList></GameList>
    <!-- <RedEnvelope v-if="userInfo && userInfo.login"></RedEnvelope> -->
...
import GameList from "@/components/index/gameList";
import Notification from "@/components/index/notification";
// import RedEnvelope from "@/components/index/redenvelope";
