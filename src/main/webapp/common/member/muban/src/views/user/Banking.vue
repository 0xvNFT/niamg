...
import { defineComponentsList } from '@/assets/js/utils';
const componentsContext = require.context('@/components/money', false, /\.vue$/);
const components = defineComponentsList(componentsContext);
