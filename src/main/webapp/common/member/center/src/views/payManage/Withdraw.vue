<template>
  <el-card class="withdraw-page">
    ...
    <div class="item">
      ...
      <span style="margin-left: 10px" v-if="data.minDrawMoney && data.maxDrawMoney"
    ...
    <div class="footBox">
      ...
      <!-- 今日剩余提款次数 -->
      <div class="item-bottom" v-if="data.lastTimes != -1">
