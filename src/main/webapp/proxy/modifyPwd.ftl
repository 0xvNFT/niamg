<form action="${proxyBase}/updloginpwd.do" class="form-submit" unReloadTable="true">
            ...
            <div class="modal-body">
                <table class="table table-bordered table-striped" style="clear: both">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" value="${loginUser.username}" disabled="disabled"/>
                        </td>
                    </tr>
                    <tr class="recepitPwdHid">
