<form class="fui-search table-tool" method="post">
    <div class="form-group fui-data-wrap">
        ...
        <div class="form-inline mt5px">
            ...
            <div class="input-group">
                <input type="text" class="form-control" name="bgRemark"  placeholder="<@spring.message "admin.deposit.bgRemark"/>" style="width: 150px;">
            </div>
            <div class="input-group">
...
requirejs(['jquery','bootstrap','Fui'], function () {
    ...
    Fui.addBootstrapTable({
        ...
        showAllSummary: true,
        showFooter: true,
        url: '${adminBase}/finance/moneyHistory/list.do',
        columns: [{
            field: 'id',
            ...
            field: 'bgRemark',
            title: '<@spring.message "admin.money.history.bgRemark"/>',
            align: 'center',
            valign: 'middle',
            formatter: remarkFormatter
        }]
