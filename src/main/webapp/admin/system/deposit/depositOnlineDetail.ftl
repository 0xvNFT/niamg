...
<form class="form-submit" id="depositset_online_modify_form_id">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close fui-close" aria-hidden="true">&times;</button>
                <h4 class="modal-title"><@spring.message "admin.deposit.online.details.of.online.payment.method"/></h4>
            </div>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td width="30%"><input placeholder="<@spring.message "admin.deposit.online.enter.correct.merchantcode"/>" name="merchantCode"
                                               value="${online.merchantCode }" class="form-control"
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input placeholder="<@spring.message "admin.deposit.online.merchantkey.privatekey"/>" name="merchantKey"
                                               value="${online.merchantKey }" class="form-control" disabled="disabled"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3"><input placeholder="<@spring.message "admin.deposit.online.payment.accountnumber.emailaddress"/>" name="account"
                                               value="${online.account }" class="form-control" disabled="disabled"></td>
                    </tr>
                    <tr>
                        <td class="text-right media-middle">APPID：</td>
                        <td><input placeholder="<@spring.message "admin.deposit.online.paypay"/>APPID" name="appid" value="${online.appid }" class="form-control"
                                   disabled="disabled">
                        </td>
                        <td class="text-right media-middle"><@spring.message "admin.status"/>：</td>
                        <td><select name="status" class="form-control" disabled="disabled">
                                <option value="1"
                    ...
                    <tr>
                        ...
                        <td><input placeholder="<@spring.message "admin.deposit.bank.bankCard.min.right"/>" name="min" value="${online.min }" disabled="disabled"
                                   class="form-control money"/></td>
                        <td class="text-right media-middle"><@spring.message "admin.deposit.bank.bankCard.max"/>：</td>
                        <td><input placeholder="<@spring.message "admin.deposit.bank.bankCard.max.right"/>" name="max" value="${online.max }" disabled="disabled"
                                   class="form-control money"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input placeholder="<@spring.message "admin.deposit.online.payment.correct.iconaddress"/>" name="icon" value="${online.icon }"
                                   class="form-control regexp" regexp="[^<]+" tip="<@spring.message "admin.deposit.online.payment.enter.iconaddress"/>" disabled="disabled"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input placeholder="<@spring.message "admin.deposit.online.maximum.value.recharge.fen"/>" name="randomAdd" value="${online.randomAdd}"
                                   class="form-control digits" type="number" disabled="disabled"></td>
                    ...
                    <tr>
                        ...
                        <td><input placeholder="<@spring.message "admin.deposit.online.alternative.parameters"/>" type="text" name="alterNative"
                                   value="${online.alterNative }" class="form-control" disabled="disabled"></td>
                        ...
                        <td><input placeholder="<@spring.message "admin.deposit.remark.bgRemark"/>" type="text" name="bgRemark"
                                   value="${online.bgRemark }" class="form-control" disabled="disabled"></td>
                    </tr>
                    <tr>
                        <td class="text-right media-middle"><@spring.message "admin.deposit.online.pc.alternative"/>：</td>
                        <td>
                            <input placeholder="<@spring.message "admin.deposit.online.front.desk.prompt"/>" disabled="disabled" name="pcRemark"
                                   value="${online.pcRemark}" class="form-control regexp" regexp="[^<]+" tip="<@spring.message "admin.deposit.online.please.enter.prompt"/>"/>
                        </td>
                        <td class="text-right media-middle"><@spring.message "admin.deposit.online.wap.remarks"/>：</td>
                        <td><input placeholder="<@spring.message "admin.deposit.online.front.desk.prompt"/>" disabled="disabled" type="text" name="wapRemark"
                                   value="${online.wapRemark}" class="form-control regexp" regexp="[^<]+" tip="<@spring.message "admin.deposit.online.please.enter.prompt"/>">
                        </td>
                    </tr>

                    <tr>
                        <td class="text-right media-middle"><@spring.message "admin.deposit.online.app.remarks"/>：</td>
                        <td><input placeholder="<@spring.message "admin.deposit.online.please.enter.app.prompt"/>" disabled="disabled" type="text" name="appRemark"
                                   value="${online.appRemark}" class="form-control regexp" regexp="[^<]+" tip="<@spring.message "admin.deposit.online.please.enter.prompt"/>">
                        </td>
                    </tr>
                    <tr class="pay-gateway">
                        ...
                        <td colspan="3"><input placeholder="<@spring.message "admin.deposit.online.correct.payment.gateway"/>" type="text" name="payGetway"
                                               value="${online.payGetway }" class="form-control" disabled="disabled">
                        </td>
                    </tr>
                    <tr class="pay-gateway">
                        ...
                        <td colspan="3"><input id="queryGateway" placeholder="<@spring.message "admin.deposit.online.query.gateway.secondary.verification"/>" type="text"
                                               name="queryGateway"
                                               value="${online.queryGateway }" class="form-control" disabled="disabled">
                        </td>
                    </tr>
...
<#--                        <td><select name="systemType" class="form-control" disabled="disabled">-->
...
<#--                    </tr>-->
                    <tr>
                        ...
                        <td><select name="isFixedAmount" class="form-control" disabled="disabled">
                        ...
                        <td><input disabled="disabled" placeholder="<@spring.message "admin.deposit.online.multiple.amounts.separated"/>" name="fixedAmount"
                                   value="${online.fixedAmount}"
                    ...
                    <tr>
                        ...
                        <td><select name="def" class="form-control" disabled="disabled">
                                <option value="1"
                    ...
                    <#--<input type="text" class="form-control fui-date" format=" HH:mm:ss" name="begin" disabled="disabled" placeholder="开始时间" value="${online.depositDailyStartTime }"> <span class="glyphicon glyphicon-th form-control-feedback" aria-hidden="true"></span>-->
                    <#--</div></td>-->
                    <#--<td class="text-right media-middle">结束时间：</td>-->
                    <#--<td class="text-left"><div class="input-group">-->
                    <#--<input type="text" class="form-control fui-date" format=" HH:mm:ss" name="end" disabled="disabled" placeholder="结束时间" value="${online.depositDailyEndTime }"> <span class="glyphicon glyphicon-th form-control-feedback" aria-hidden="true"></span>-->
                    <#--</div></td>-->
                    <#--</tr>-->
                    <tr class="hidden third-pay">
                        <td class="text-right media-middle"><@spring.message "admin.deposit.online.display.type"/>：</td>
                        <td colspan="3">
                            <select name="showType" class="form-control" disabled="disabled">
                                <option value="all"
                                        <#if online.showType=='all'>selected</#if>
                                ><@spring.message "admin.deposit.online.all.terminals.display"/>
                                </option>
                                <option value="pc"
                                        <#if online.showType=='pc'>selected</#if>
                                ><@spring.message "admin.deposit.online.pc.display"/>
                                </option>
                                <option value="mobile"
                                        <#if online.showType=='mobile'>selected</#if>
                                ><@spring.message "admin.deposit.online.phone.display"/>
                                </option>
                                <option value="app"
                                        <#if online.showType=='app'>selected</#if>
                                ><@spring.message "admin.deposit.online.app.display"/>
                                </option>
                            </select>
                        </td>
                    </tr>
