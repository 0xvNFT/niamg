            ...
            <div class="modal-body">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td class="text-left"><input type="text" name="productImg" class="form-control" placeholder="<@spring.message "admin.suggest.pic.path"/>"/></td>
                    </tr>
                   <#-- <tr>
                        <td class="text-right media-middle"></td>
                        <td class="text-left"><input type="file" name="productImage" class="form-control" /></td>
                    </tr>-->
                    <tr>
