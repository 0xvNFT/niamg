<form id="member_modifypay_pwd_form_id1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close fui-close" aria-hidden="true">&times;</button>
                <h4 class="modal-title"><@spring.message "admin.update.pay.pass"/></h4>
            </div>
...
<script type="text/javascript">
    requirejs(['jquery'],function(){
        var $form=$("#member_modifypay_pwd_form_id1");
        $form.submit(function(){
            ...
            $.ajax({
                url : "${adminBase}/user/doUpdatePayPwd.do",
                data : {
                    id: '${id }',
                    pwd : password,
                    rpwd : rpassword,
