<form action="${adminBase}/user/doBatchEnableStatus.do" class="form-submit" id="member_enable_batch_modify_form_id">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close fui-close" aria-hidden="true">&times;</button>
                <h4 class="modal-title"><@spring.message "admin.bat.able.user"/></h4>
            </div>
...
requirejs(['jquery'], function () {
    var $form = $("#member_enable_batch_modify_form_id"),usernames = '';
