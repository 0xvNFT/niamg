...
/** 出款 */
public class UzpaydaifuReplacePayWrapper implements ReplacePayWrapper {
	private static Logger log = LoggerFactory.getLogger(UzpaydaifuReplacePayWrapper.class);
	private static String NOTIFY_URL = "@{merchant_domain}/onlinePay/ReplaceNotify/v2/";
	private static String iconCss = "uzpaydaifu";
	...
	public JSONObject wrap(String... params) {
		...
		UzpayResultOrder result = new UzpayPayApi().agentpay(mechKey,merchantAccount, payGetway,param);
