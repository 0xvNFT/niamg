...
import com.play.pay.baxiuzpay.http.HttpClientForTopay;
import com.play.pay.baxiuzpay.params.*;
import com.play.pay.baxiuzpay.result.UzpayResultBalance;
import com.play.pay.baxiuzpay.result.UzpayResultOrder;
import com.play.pay.baxiuzpay.util.SignAPI;
...
public class UzpayPayApi {
	private final static Logger log = LoggerFactory.getLogger(UzpayPayApi.class);
	...
	public UzpayResultOrder collection(String publicKey, String privateKey, String url, UzpayParamCollect param) {
	...
	//	log.error(JSONObject.toJSONString(param));
		return getResult(publicKey, privateKey, param, formattedURL, UzpayResultOrder.class);
	}

	public UzpayResultOrder agentpay(String publicKey, String privateKey, String url, UzpayParamPay param) {
	...
	public UzpayResultOrder queryOrderStatus(String publicKey, String privateKey, String url, TopayParamQueryOrder param) {
		String formattedURL = String.format(QUERY_ORDER_STATUS_SUFFIX, urlFormat(url));
		return getResult(publicKey, privateKey, param, formattedURL, UzpayResultOrder.class);
	}

	public UzpayResultBalance queryBalance(String publicKey, String privateKey, String url, UzpayParamQueryBalance param) {
		StringBuilder sb = new StringBuilder();
		sb.append("mch_id=").append(param.getMch_id()).append("&");
		...
		return getResult(publicKey, privateKey, param, formattedURL, UzpayResultBalance.class);
	}
