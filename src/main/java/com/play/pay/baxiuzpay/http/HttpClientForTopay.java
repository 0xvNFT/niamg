package com.play.pay.baxiuzpay.http;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.play.pay.baxiuzpay.UzpayPayApi;
import com.play.pay.baxiuzpay.params.ITopayParamBase;
...
public class HttpClientForTopay extends HttpClientProxy {
	...
	private final static Logger logger = LoggerFactory.getLogger(HttpClientForTopay.class);
	...
	public Response curlPostXForm(String url) {
		logger.error(content);
		this.set_Content(content);
		return curl(url, HttpType.POST_XFROM);
	}
	...
	public void addHeader(List<Header> headerList) {
		headerList.add(new BasicHeader("Content-Type", "x-www-form-urlencoded; charset=utf-8"));
	}
