package com.play.pay.baxiwowpay.util;
...
public class TopayRSAEncrypt {
    ...
    private static String data = "王康颖"; //$NON-NLS-1$
...
/*    public static void main(String[] args) throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException, IOException {
        String jiami = encrypt(privateKey,data);
        System.out.println("加密数据： " + jiami);
        String decrypt = decrypt(publicKey, jiami);
     ...
     * @throws IOException
     */
    public static String encrypt(String key,String data) throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException, IOException{
