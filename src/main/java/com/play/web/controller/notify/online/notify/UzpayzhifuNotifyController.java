...
public class UzpayzhifuNotifyController extends FrontBaseController implements PayNotifyWrapper {
 //   private static Logger logger = LoggerFactory.getLogger(UzpayzhifuNotifyController.class);
    @Override
    ...
    //    logger.error("Uzpay支付v2成功收到回调通知，订单号：" + orderNumber);
