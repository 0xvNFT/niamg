...
public class GoopagodaifuReplaceNotifyController extends FrontBaseController implements ReplaceNotifyWrapper {
//	private static Logger logger = LoggerFactory.getLogger(GoopagodaifuReplaceNotifyController.class);
	...
	//	logger.error("回调goopago代付数据:" + JSONObject.toJSONString(map));
		String ordernumber = map.get("mchOrderNo").toString();
		// 用户提款记录
	//	logger.error("goopago代付成功收到回调通知，订单号：" + ordernumber);
