...
public class MipayzhifuNotifyController extends FrontBaseController implements NotifyWrapper {
    ...
    private static Logger logger = LoggerFactory.getLogger(MipayzhifuNotifyController.class);
