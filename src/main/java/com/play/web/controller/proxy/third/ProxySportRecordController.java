...
@Controller
@RequestMapping(SystemConfig.CONTROL_PATH_PROXY + "/sportRecord")
public class ProxySportRecordController extends ProxyBaseController {
    ...
    public String index(String begin, String end, String username, Map<String, Object> map, String proxyName) {
        ...
        map.put("endTime", end);
        map.put("platforms2", PlatformType.getSportPlatforms());
        map.put("platforms", PlatformType.values());
        return returnPage("/third/sportRecordIndex");
    }
    ...
    public void list(ThirdSearchVo v, String proxyName) {
        ...
        if (StringUtils.isEmpty(proxyName)) {
            ...
            proxy = thirdCenterService.getSportPage(v);
            v.setUsername(null);
        }
        ...
        user = thirdCenterService.getSportPage(v);
    ...
    public String viewDetail(Long id, Integer type) {
        ...
        String url = thirdCenterService.getDetailUrl(id, type, 4, SystemUtil.getStation());
