...
@Controller
@RequestMapping(SystemConfig.CONTROL_PATH_PROXY + "/ptRecord")
public class ProxyPtRecordController extends ProxyBaseController {
    ...
    public void list(ThirdSearchVo v,String proxyName) {
        ...
        if (StringUtils.isEmpty(proxyName)) {
            ...
            proxy = thirdCenterService.getPtPage(v);
            v.setUsername(null);
        }
        ...
        user = thirdCenterService.getPtPage(v);
