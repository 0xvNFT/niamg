...
public class HttpConnectionManagerForTransMoney {
	/**
	 * 最大连接数
	 */
	...
	private static Logger logger = LoggerFactory.getLogger(HttpConnectionManagerForTransMoney.class);
	/**
	 * 读取超时时间
	 */
	 ...
	 */
	private static int CONNECT_REQUEST_TIMEOUT = 10000;
	/**
	 * 链接失败重试次数
	 */
