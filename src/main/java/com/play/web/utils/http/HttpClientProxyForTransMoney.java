...
public abstract class HttpClientProxyForTransMoney {
    ...
    private Logger logger = LoggerFactory.getLogger(HttpClientProxyForTransMoney.class);
    ...
    public HttpClient getClient() {
        return HttpConnectionManagerForTransMoney.getHttpClient();
    }
