 ...
 * 下面简略介绍一下阴历阳历转换的算法原理：
 * 
 * 阳历，有很强的规律性。每年12个月，1、3、5、7、8、10、12月都为31天；2月份平年28天，能被4除尽的年份里为29天，但1900年为28天；
 * 其余月份为31天。阴历却没有什么特定的规律，是根据天文观测得到的某月是29天还是30天。下面是经过整理的150年内的阴历数据
 * 
 * 然后解释一下表中的数据，拿第一个0x04bd8来说吧，他是5个16进制数，共20bit。最后四位，即8，代表该年闰月的月份，为0则没有闰月。前四位，即0，
 * 在该年有闰月才有意义，为0表示闰月29天，为1表示闰月30天。中间12位，即4bd代表该年12个月每个月的天数，0表示29天，1表示30天。
 * 
...
public class LunarCalendarUtil {
	...
	// Logger.getLogger(LunarCalendarUtil.class);
	// 计算阴历日期参照1900年到2049年
	private final static int[] LUNAR_INFO = { 0x04bd8, 0x04ae0, 0x0a570, 0x054d5, 0x0d260, 0x0d950, 0x16554, 0x056a0, 0x09ad0, 0x055d2, 0x04ae0, 0x0a5b6, 0x0a4d0, 0x0d250, 0x1d255, 0x0b540, 0x0d6a0, 0x0ada2, 0x095b0, 0x14977, 0x04970, 0x0a4b0, 0x0b4b5, 0x06a50, 0x06d40, 0x1ab54, 0x02b60, 0x09570, 0x052f2, 0x04970, 0x06566, 0x0d4a0, 0x0ea50, 0x06e95, 0x05ad0, 0x02b60, 0x186e3, 0x092e0, 0x1c8d7, 0x0c950, 0x0d4a0, 0x1d8a6, 0x0b550, 0x056a0, 0x1a5b4, 0x025d0, 0x092d0, 0x0d2b2, 0x0a950, 0x0b557,
			...
			0x07552, 0x056a0, 0x0abb7, 0x025d0, 0x092d0, 0x0cab5, 0x0a950, 0x0b4a0, 0x0baa4, 0x0ad50, 0x055d9, 0x04ba0, 0x0a5b0, 0x15176, 0x052b0, 0x0a930, 0x07954, 0x06aa0, 0x0ad50, 0x05b52, 0x04b60, 0x0a6e6, 0x0a4e0, 0x0d260, 0x0ea65, 0x0d530, 0x05aa0, 0x076a3, 0x096d0, 0x04bd7, 0x04ad0, 0x0a4d0, 0x1d0b6, 0x0d250, 0x0d520, 0x0dd45, 0x0b5a0, 0x056d0, 0x055b2, 0x049b0, 0x0a577, 0x0a4b0, 0x0aa50, 0x1b255, 0x06d20, 0x0ada0 };
	...
	public static int getLunarYear(Date myDate) {
		int i;
		int temp = 0;
		SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");
		Date startDate = null;
	...
	public static void main(String[] args) throws Exception {
		System.out.println(LunarCalendarUtil.lunarToSolar("19901204", false));
		System.out.println(LunarCalendarUtil.lunarToSolar("19841021", true));
		System.out.println("************");
		System.out.println(LunarCalendarUtil.solarToLunar("19000923"));
		System.out.println(LunarCalendarUtil.solarToLunar("19000924"));
		System.out.println(LunarCalendarUtil.solarToLunar("19001022"));
		System.out.println(LunarCalendarUtil.solarToLunar("19001023"));

		System.out.println(LunarCalendarUtil.solarToLunar("19900630"));
		System.out.println(LunarCalendarUtil.solarToLunar("19841213"));
		System.out.println(LunarCalendarUtil.solarToLunar("19910119"));

		System.out.println(LunarCalendarUtil.solarToLunar("19880915"));

		System.out.println(LunarCalendarUtil.lunarToSolar("20161206", false));
		Calendar c=Calendar.getInstance();
		c.set(2020, 0, 24);
		System.out.println(LunarCalendarUtil.getLunarYear(c.getTime()));
	}
}
