...
public class Sm4Utils {
	...
	public String decode(String input, String key) throws IOException {
		byte[] b_input = Base64.decode(input);
		byte[] b_key = new byte[16];
		byte[] bbs = key.getBytes("utf-8");
	...
	public static void main(String[] args) throws IOException {
		String key="admin#$%^feqfewqfewqgqfvewqfewqfewqfewqfewqfewqfewqadmin#$%^feqfewqfewqgqfvewqfewqfewqfewqfewqfewqfewqadmin#$%^feqfewqfewqgqfvewqfewqfewqfewqfewqfewqfewqadmin#$%^feqfewqfewqgqfvewqfewqfewqfewqfewqfewqfewq";
		String s = new Sm4Utils().encode("待加密admin#$%^feqfewqfewqgqfvewqfewqfewqfewqfewqfewqfewqadmin#$%^feqfewqfewqgqfvewqfewqfewqfewqfewqfewqfewqadmin#$%^feqfewqfewqgqfvewqfewqfewqfewqfewqfewqfewqadmin#$%^feqfewqfewqgqfvewqfewqfewqfewqfewqfewqfewqadmin#$%^feqfewqfewqgqfvewqfewqfewqfewqfewqfewqfewqadmin#$%^feqfewqfewqgqfvewqfewqfewqfewqfewqfewqfewq", key);
		System.out.println(s);
		String j = new Sm4Utils().decode(s, key);
